...
- Make the 3D/Canvas introduction feel more geological: an illustrative grid rises into ridges and a valley, reveals layered surfaces, and carries a cobalt scan line. Keep the white/blue editorial style, reversible scroll progress, a clear flat/terrain interaction, subtle desktop pointer parallax, and a complete mobile view. Render only while the visible scene changes; reduced motion shows a stable completed state.
