...
- Opening paper motion should flutter DOWN and OUT to the sides, with staggered starts, broad bends and gentle swaying. Brief scroll compensation makes the descent perceptible; fade the intact sheets before they obstruct the following content. Preserve deterministic reverse scrolling and reduced motion.
