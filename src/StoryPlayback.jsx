...
const demos={
 ...
 frameworks:[stop('frameworks','#frameworks .framework-app','One article appears in three connected views.',3500,()=>click('frameworks','Remove saved idea')),stop('frameworks','#frameworks .framework-app','Save one idea. The button, count and list update from the same state.',5000,()=>click('frameworks','Save this idea')),stop('frameworks','#frameworks .framework-app','Each part has a boundary. Together, they make an application.',4500,()=>click('frameworks','Show component boundaries')),stop('frameworks','#frameworks .framework-approaches','AngularJS: templates, binding and application structure.',5000,()=>click('frameworks','Angular')),stop('frameworks','#frameworks .framework-approaches','React: describe the interface as a composition of components.',5000,()=>click('frameworks','React')),stop('frameworks','#frameworks .framework-approaches','Vue: reactive templates and progressive adoption.',5000,()=>click('frameworks','Vue'))],
